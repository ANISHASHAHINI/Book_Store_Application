    ...
    <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
            ...
            <div className='md:w-1/2 space-y-8 h-full'>
                ...
                <p className='md:w-4/5 '>Your Gateway to the World of Imagination! Discover a 
                    treasure trove of knowledge, adventure, 
                    and inspiration within the pages of our vast collection. 
                    Whether you're a passionate reader, an avid bookworm, or just looking 
                    for your next great read, we've got something for everyone.</p>
                <div>
                  <input type="search" name='search' id='search' placeholder='Search a book' className='py-2
                  px-2 rounded-sm outline-none' />
